...
function Header() {
  return (
    ...
    <header className="flex bg-transparent justify-center sticky top-0">
        <nav className="flex m-6 py-3 px-4 bg-[#232323] text-white rounded-xl shadow-lg">
            <ul className="flex gap-8 items-center bg-[#232323]">

                {/* Home Icon */}
                <li>
                    <a href="#home" className="">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-7 bg-[#232323]">
